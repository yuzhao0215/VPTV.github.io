...
#include <windows.h>
//#include "C:\OptiTrack\Camera SDK\include\cameralibrary.h"
...
namespace lpt {
	...
	protected:
		...
		int current_camera_idx; // current camera index to change videomode or exposure time
	};
	...
	public:		
		...
		friend void callbackSetCurrentIdx(int idx, void* data );
