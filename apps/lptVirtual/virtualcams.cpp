...
int main(int argc, char** argv) {
	...
	cout << "test of git hahahahah" << endl;

	string input = (argc > 1 ? argv[1] : "../../../data/input/");
	string output = (argc > 2 ? argv[2] : "../../../data/output/");
	string camerasfile = "../../../data/tests/pivstd/6cams/cameras.yaml"; //"../../../data/input/07_19_2019cameras.yaml";//"../../../data/pivstd/4cams/cameras.yaml"; 
	string campairsfile ="../../../data/tests/pivstd/6cams/camera_pairs.yaml"; //"../../../data/input/07_19_2019pairs.yaml"; //"./output/camera_pairs.yaml"; //
	...
	visualizer->getVolumeGrid()->setGridOrigin(-100, -100, -100);
	visualizer->getVolumeGrid()->setGridDimensions(200,200,200); // mm
	visualizer->getVolumeGrid()->setGridCellCounts(15,15,15);
	...
	pipeline.load_Rotation_Matrix_virtual();
